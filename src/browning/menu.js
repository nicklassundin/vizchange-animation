...
// Spring
        this.addSeason(0, this.timelines.menu, 'Spring', yest_spring, today_spring, tom_spring)
// Summer
        this.addSeason(6*this.speed, this.timelines.menu,'Summer', yest_summer, today_summer, tom_summer)
//autumn
        this.addSeason(12*this.speed, this.timelines.menu, 'Autumn', yest_autumn, today_autumn, tom_autumn);
// Winter
        this.addSeason(18*this.speed, this.timelines.menu, 'Winter', yest_winter, today_winter, tom_winter);
// End Spring

    }
    addSeason (time, tl, id, yest_season, today_season, tomorrow_season) {
